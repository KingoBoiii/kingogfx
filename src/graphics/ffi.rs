...
#[unsafe(no_mangle)]
pub extern "C" fn kgfx_graphics_create_context(kind: BackendKind, window_handle: *mut WindowHandle, out_ctx: *mut *mut GraphicsContext) -> GfxStatus {
...
#[unsafe(no_mangle)]
pub extern "C" fn kgfx_graphics_viewport(ctx: *mut GraphicsContext, x: i32, y: i32, width: i32, height: i32) -> GfxStatus {
	if ctx.is_null() {
		return GfxStatus::NullPointer;
	}
